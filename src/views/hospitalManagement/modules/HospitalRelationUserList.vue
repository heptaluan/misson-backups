...
<!--                <a-menu-item>-->
    ...
    <Hospital-Select-User-Modal ref='selectUserModal' @selectFinished='selectOK'></Hospital-Select-User-Modal>
...
import HospitalSelectUserModal from './HospitalSelectUserModal'
import UserModal from './HospitalUserModal'
import PasswordModal from '../../system/modules/PasswordModal'

export default {
  name: 'HospitalRelationUserList',
  mixins: [JeecgListMixin],
  components: {
    HospitalSelectUserModal,
    UserModal,
    PasswordModal
  },
  data() {

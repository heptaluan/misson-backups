        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="代谢总览" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="ananpanReportAll">
              <a-input v-model="model.ananpanReportAll" placeholder="请输入代谢总览"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="影像结果总览" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="imageReportAll">
              <a-input v-model="model.imageReportAll" placeholder="请输入影像结果总览"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="基因结果总览" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="geneReportAll">
              <a-input v-model="model.geneReportAll" placeholder="请输入基因结果总览"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/report/sampleReportSource/add",

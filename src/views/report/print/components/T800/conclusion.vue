...
<div class="conclusion">
  ...
  <div class="conclusion-content">
    <p>{{conclusion.description}}<a-checkbox-group :options="riskLevel" :value="risk" @change="onChange" />。{{conclusion.hint}}<span v-html="conclusion.content"></span></p>
  </div>
</div>
</template>

<script>
import { conclusion as conc } from '../../../template/resource/constant'
export default {
  name: 'conclusion',
  props: {
    data: {

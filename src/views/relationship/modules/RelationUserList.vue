      ...
      >
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              <!--                <a-menu-item>-->
              <!--                <a href='javascript:;' @click='handleDeptRole(record)'>渠道商角色</a>-->
              <!--              </a-menu-item>-->
              ...
              <a-menu-item>
                <a-popconfirm title='确定取消与选中渠道商关联吗?' @confirm='() => handleDelete(record.id)'>
                  <a>取消关联</a>
                </a-popconfirm>
              </a-menu-item>
            </a-menu>
  ...
  methods: {
    ...
    batchDel: function() {
      ...
      if (!this.currentDeptId) {
        this.$message.error('未选中任何渠道商，无法取消渠道商与用户的关联!')
        return
      }
    ...
    handleDeptRole(record) {
      if (this.currentDeptId != '') {
        ...
        this.$refs.deptRoleUser.title = '渠道商角色分配'
      } else {
        this.$message.warning('请先选择一个渠道商!')
      }
    },

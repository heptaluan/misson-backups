    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="总量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="noTotal">
              <a-input-number v-model="model.noTotal" placeholder="请输入总量" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="周预计量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="noWeek">
              <a-input-number v-model="model.noWeek" placeholder="请输入周预计量" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="单位" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="units">
              <a-input v-model="model.units" placeholder="请输入单位"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/mission/projectSamplePlan/add",
          edit: "/mission/projectSamplePlan/edit",
          queryById: "/mission/projectSamplePlan/queryById"
        }
      }
    },
    computed: {

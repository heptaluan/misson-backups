    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="耗材数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="materialPcs">
              <a-input-number v-model="model.materialPcs" placeholder="请输入耗材数量" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/mission/materialStock/add",
          edit: "/mission/materialStock/edit",
          queryById: "/mission/materialStock/queryById"
        }
      }
    },
    computed: {

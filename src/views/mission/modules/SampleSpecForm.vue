    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="单位" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="specUnit">
              <a-input v-model="model.specUnit" placeholder="请输入单位"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/mission/sampleSpec/add",
          edit: "/mission/sampleSpec/edit",
          queryById: "/mission/sampleSpec/queryById"
        }
      }
    },
    computed: {

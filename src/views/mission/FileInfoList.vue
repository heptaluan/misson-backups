<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleUpload" type="primary" icon="plus" v-has="'fileAdd'">新增</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'fileAdd'">编辑</a>

          <a-divider type="vertical" v-has="'fileAdd'" />
          <a-dropdown>
    ...
    <file-upload-modal ref="uploadModalForm" @ok="modalFormOk" :fileType="queryParam.ownershipType" :modalType = '2'></file-upload-modal>

...
<script>
  ...
  export default {
    ...
    watch: {
      ...
      // treeData(n,o) {
      //   console.log(this.alldepart,', new: ',n,'-',o)
      // }
    },
    computed:{
      treeScreenClass() {
    ...
    methods: {
      ...
      loadDepart() {
        ...
        queryDepartTreeList().then(res => {
          if (res.success) {
            let arr = [...res.result]
            // console.log('company tree:', arr)
            this.dataList = [] // because the parent component can contains multiple this module, the dataList should be clean before rewrite

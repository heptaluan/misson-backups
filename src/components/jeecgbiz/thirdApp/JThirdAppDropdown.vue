<template>
  ...
  <a-button v-else-if="syncToApp" type="primary" icon="sync" @click="handleMenuClick({ key: 'to-app' })"
    >同步{{ name }}</a-button
  >
  <a-button v-else type="primary" icon="sync" @click="handleMenuClick({ key: 'to-local' })"
